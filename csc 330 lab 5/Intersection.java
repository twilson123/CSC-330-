...
public class Intersection implements Comparable<Intersection>  
{
	...
	{  //it will make it in order 
		if(this.avenue == corner.avenue)
			return new Integer(this.street).compareTo(corner.street);//if avenue equal, compare street
		
		return new Integer(this.avenue).compareTo(corner.avenue);// sent the result of compare avenue
	}
	...
	public static void main(String[] args)
	{
		...
		System.out.println(set);//call toString
